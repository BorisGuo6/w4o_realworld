...
This list is generated using your API key via the ListModels endpoint (v1beta).

Note: Availability and methods can change over time; run ListModels again for updates.

## Model Usage in This Project

### Image Generation & Editing Models
- **`gemini-2.0-flash-preview-image-generation`** (Default) - Standard image generation and editing
- **`gemini-2.5-flash-image-preview`** (High Performance) - Advanced image generation and editing with better quality

### Text Processing Models (Unified)
- **`gemini-2.5-pro`** (Primary) - High-performance text processing, analysis, and reasoning
- **`gemini-1.5-flash-latest`** (Fallback) - Reliable text processing with good performance (used as fallback for image analysis)

**Note**: All text processing tasks (prompt enhancement, object extraction, validation, etc.) now use `gemini-2.5-pro` for optimal performance and quality.

## Text/Multimodal
- models/gemini-1.5-pro-latest (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-1.5-pro-002 (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-1.5-pro (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-1.5-flash-latest (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-1.5-flash (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-1.5-flash-002 (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-1.5-flash-8b (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-1.5-flash-8b-001 (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-1.5-flash-8b-latest (generateContent, countTokens, createCachedContent, batchGenerateContent)
...
- models/gemini-2.0-flash-exp (generateContent, countTokens, createCachedContent, batchGenerateContent)
...
- models/gemini-2.5-flash-preview-tts (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-2.5-pro-preview-tts (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-2.5-flash-lite (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/text-embedding-004 (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-embedding-exp-03-07 (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-embedding-exp (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-embedding-001 (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-2.5-flash-preview-native-audio-dialog (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-2.5-flash-exp-native-audio-thinking-dialog (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-2.0-flash-live-001 (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-live-2.5-flash-preview (generateContent, countTokens, createCachedContent, batchGenerateContent)
- models/gemini-2.5-flash-live-preview (generateContent, countTokens, createCachedContent, batchGenerateContent)
...
- models/imagen-3.0-generate-002 (generateContent)
- models/imagen-4.0-generate-preview-06-06 (generateContent)
- models/imagen-4.0-ultra-generate-preview-06-06 (generateContent)
- models/imagen-4.0-generate-001 (generateContent)
- models/imagen-4.0-ultra-generate-001 (generateContent)
- models/imagen-4.0-fast-generate-001 (generateContent)
- models/veo-2.0-generate-001 (generateContent)
- models/veo-3.0-generate-preview (generateContent)
- models/veo-3.0-fast-generate-preview (generateContent)

## Audio
- models/gemini-2.5-flash-preview-native-audio-dialog (generateContent, countTokens)
- models/gemini-2.5-flash-exp-native-audio-thinking-dialog (generateContent, countTokens)
...
## Embeddings
- models/embedding-gecko-001 (embedContent, countTokens)
- models/embedding-001 (embedContent, countTokens)
...
## Other Models
- models/learnlm-2.0-flash-experimental (generateContent)
