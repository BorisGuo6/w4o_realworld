...
from rlbench.tasks import TakeFrameOffHanger, OpenDoor, PutBooksOnBookshelf, ReachTarget, CloseBox, PutShoesInBox, PickAndLift, PickUpCup, OpenWineBottle, PushButton
...
def main():
    ...
    task = env.get_task(PutShoesInBox)
