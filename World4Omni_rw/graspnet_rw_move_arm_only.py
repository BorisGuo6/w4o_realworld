...
# print(f"ee_pose_in[:3] = {ee_pose_in[:3]}")
# print(f"ee_pose_in[3:] = {ee_pose_in[3:]}")

# print(f"ee_pose_out[:3] = {ee_pose_out[:3]}")
# print(f"ee_pose_out[3:] = {ee_pose_out[3:]}")
...
# ee_pose_in[:3] = [ 0.35605133 -0.20671773  0.01390151]
# ee_pose_in[3:] = [-172.70186846  -36.65750405 -100.23924953]
# ee_pose_out[:3] = [ 0.35447201 -0.15829026  0.07755907]
# ee_pose_out[3:] = [-172.70186846  -36.65750405 -100.23924953]
# t_goal = [ 0.72795028 -0.00211281 -0.15564953]
# euler_goal = [155.68493633 -45.05867966 -61.80704728]
...
ee_pose_in[:3] = [0.3395106870055124, -0.21002554229303494, 0.01948509584463056]
ee_pose_in[3:] = [-172.70186846342767, -36.65750404909905, -100.23924952858336]
ee_pose_out[:3] = [0.3379313683871284, -0.1615980700866872, 0.08314266168251853]
ee_pose_out[3:] = [-172.70186846342767, -36.65750404909905, -100.23924952858336]
t_goal = [0.7163336128260183, -0.00785630395453868, -0.1434932040434656]
euler_goal = [155.68493632505533, -45.05867966021994, -61.80704728043139]
