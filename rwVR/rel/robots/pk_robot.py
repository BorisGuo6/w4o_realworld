...
from rel import XARM6_WO_EE_URDF_PATH, XARM7_WO_EE_URDF_PATH, XARM7_URDF_PATH
from rel.utils import load_link_geometries, vis_robot_frames
...
class XArm7(RobotArm):
    def __init__(
        self,
        urdf_path: Path = XARM7_URDF_PATH,
        load_visual_mesh: bool = True,
        load_col_mesh: bool = True,
        dtype=torch.float,
        device="cuda",
